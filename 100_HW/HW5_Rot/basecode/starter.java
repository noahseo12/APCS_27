...
public class starter {
    ...
    public static void main(String[] args) {
        ...
        rizzPower = rizzPower+trainingBonus;

        int sigmaSpeed = (int)(Math.random()*20)+10;
        
        int brainrotEnergy= (int)(Math.random()*20)+5;
        brainrotEnergy = (brainrotEnergy+trainingBonus)/2;
        ...
        int finalDamage = ((rawDamage - rivalDefense));
        finalDamage = Math.max(10, finalDamage);
        ...
        rivalHealthRemaining = Math.max(1, rivalHealthRemaining);
        ...
        int heroHealthRemaining = (100 - rivalDamage);
        heroHealthRemaining = Math.max(1,heroHealthRemaining);
        ...
        int basePoints = (int)(Math.random()*(250)+300);
